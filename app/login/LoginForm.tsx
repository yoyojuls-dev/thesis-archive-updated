...
const LoginForm: React.FC<LoginFormProps> = ({ currentUser }) => {
  ...
  const userType = searchParams.get('type') || 'student'; // default to student
  ...
  const onSubmit: SubmitHandler<FieldValues> = (data) => {
    ...
    signIn("credentials", {
      ...
      if (callback?.ok) {
        // Let the authentication system handle the redirect based on the actual user role
        // This will be handled by the useEffect above when currentUser updates
        window.location.reload(); // Force a page reload to get the updated session
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center relative overflow-hidden">
      {/* Background Image - You can replace this with your actual background */}
      <div 
